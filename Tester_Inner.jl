...
function StabilityFinder2(m, a2, percent, t="1000P", hParam=0.01, fileSave="AutoSave")
    ...
    while sizeStep < maxsizeStep #This line indicates the number of significant figures that will be evaluated. The higher, the longer the runtime
